# arxiv-daily
 Automated deployment @ 2024-04-29 14:50:35 Asia/Taipei
...
and algorithm improvement holds the potential to improve patient outcomes and
diagnostic precision in the treatment of thyroid cancer.|
##### 2404.04686v1 **Predictive Modeling for Breast Cancer Classification in the Context of Bangladeshi Patients: A Supervised Machine Learning Approach with Explainable AI**
Taminul Islam et.al.
...
##### 2404.03892v2 **Enhancing Breast Cancer Diagnosis in Mammography: Evaluation and Integration of Convolutional Neural Networks and Explainable AI**
Maryam Ahmed et.al.
...
##### 2403.17873v1 **Addressing Social Misattributions of Large Language Models: An HCXAI-based Approach**
...
##### 2403.18871v1 **Clinical Domain Knowledge-Derived Template Improves Post Hoc AI Explanations in Pneumothorax Classification**
Han Yuan et.al.
...
##### 2403.01580v1 **Enhancing Neural Machine Translation of Low-Resource Languages: Corpus Development, Human Evaluation and Explainable AI Architectures**
Séamus Lankford et.al.
...
Shared Task.|
##### 2402.18600v1 **Artificial Intelligence and Diabetes Mellitus: An Inside Look Through the Retina**
Yasin Sadeghi Bazargani et.al.
...
##### 2402.15027v2 **Multi-stakeholder Perspective on Responsible Artificial Intelligence and Acceptability in Education**
A. J. Karran et.al.
...
##### 2402.09474v1 **Deciphering Heartbeat Signatures: A Vision Transformer Approach to Explainable Atrial Fibrillation Detection from ECG Signals**
Aruna Mohan et.al.
...
sinus bradycardia.|
##### 2402.05127v1 **Illuminate: A novel approach for depression detection with explainable analysis and proactive therapy using prompt engineering**
Aryan Agrawal et.al.
...
##### 2401.13324v4 **Information That Matters: Exploring Information Needs of People Affected by Algorithmic Decisions**
Timothée Schmude et.al.
...
##### 2401.02985v1 **Evaluating Large Language Models on the GMAT: Implications for the Future of Business Education**
Vahid Ashrafimoghari et.al.
...
##### 2312.17624v1 **XAI for In-hospital Mortality Prediction via Multimodal ICU Data**
Xingqiao Li et.al.
...
##### 2401.09450v2 **Joining Forces for Pathology Diagnostics with AI Assistance: The EMPAIA Initiative**
Norman Zerbe et.al.
...
##### 2312.11747v2 **Robust Stochastic Graph Generator for Counterfactual Explanations**
Mario Alfonso Prado-Romero et.al.
...
##### 2312.06032v1 **Evaluating the Utility of Model Explanations for Model Development**
Shawn Im et.al.
...
explanations.|
##### 2312.06798v1 **Building Trustworthy NeuroSymbolic AI Systems: Consistency, Reliability, Explainability, and Safety**
Manas Gaur et.al.
...
##### 2311.17133v1 **Deployment of a Robust and Explainable Mortality Prediction Model: The COVID-19 Pandemic and Beyond**
Jacob R. Epifano et.al.
...
##### 2311.15719v1 **Variational Autoencoders for Feature Exploration and Malignancy Prediction of Lung Lesions**
Benjamin Keel et.al.
...
feature changes.|
##### 2311.14471v1 **MRxaI: Black-Box Explainability for Image Classifiers in a Medical Setting**
Nathan Blake et.al.
...
##### 2311.12573v2 **Moderating Model Marketplaces: Platform Governance Puzzles for AI Intermediaries**
Robert Gorwa et.al.
...
##### 2311.11932v1 **Ovarian Cancer Data Analysis using Deep Learning: A Systematic Review from the Perspectives of Key Features of Data Analysis and AI Assurance**
Muta Tah Hira et.al.
...
##### 2311.10933v1 **Representing visual classification as a linear combination of words**
Shobhit Agarwal et.al.
...
##### 2311.02115v1 **Towards objective and systematic evaluation of bias in medical imaging AI**
Emma A. M. Stanley et.al.
...
##### 2310.19174v1 **Predicting recovery following stroke: deep learning, multimodal data and feature selection using explainable AI**
Adam White et.al.
...
scanners.|
##### 2310.01828v2 **Trainable Noise Model as an XAI evaluation method: application on Sobol for remote sensing image segmentation**
Hossein Shreim et.al.
...
##### 2311.01463v1 **Creating Trustworthy LLMs: Dealing with Hallucinations in Healthcare AI**
Muhammad Aurangzeb Ahmad et.al.
...
##### 2309.11196v1 **When to Trust AI: Advances and Challenges for Certification of Neural Networks**
...
##### 2309.10424v1 **Functional requirements to mitigate the Risk of Harm to Patients from Artificial Intelligence in Healthcare**
Juan M. García-Gómez et.al.
...
##### 2309.10293v3 **QXAI: Explainable AI Framework for Quantitative Analysis in Patient Monitoring Systems**
...
calculations.|
##### 2309.09917v1 **Evaluation of Human-Understandability of Global Model Explanations using Decision Tree**
Adarsa Sivaprasad et.al.
...
##### 2309.00903v2 **An explainable three dimension framework to uncover learning patterns: A unified look in variable sulci recognition**
Michail Mamalakis et.al.
...
##### 2308.14321v1 **Leveraging A Medical Knowledge Graph into Large Language Models for Diagnosis Prediction**
Yanjun Gao et.al.
...
##### 2308.09380v1 **Deciphering knee osteoarthritis diagnostic features with explainable artificial intelligence: A systematic review**
Yun Xin Teoh et.al.
...
##### 2308.08407v1 **Explainable AI for clinical risk prediction: a survey of concepts, methods, and modalities**
Munib Mesinovic et.al.
...
##### 2309.12325v1 **FUTURE-AI: International consensus guideline for trustworthy and deployable artificial intelligence in healthcare**
Karim Lekadir et.al.
...
##### 2308.05411v1 **Explainable AI applications in the Medical Domain: a systematic review**
Nicoletta Prentzas et.al.
...
##### 2308.02534v1 **Exploring the Role of Explainability in AI-Assisted Embryo Selection**
Lucia Urcelay et.al.
...
##### 2307.14246v1 **A New Perspective on Evaluation Methods for Explainable Artificial Intelligence (XAI)**
Timo Speith et.al.
...
##### 2307.14239v1 **Revisiting the Performance-Explainability Trade-Off in Explainable Artificial Intelligence (XAI)**
Barnaby Crook et.al.
Within the field of Requirements Engineering (RE), the increasing
significance of Explainable Artificial Intelligence (XAI) in aligning
AI-supported systems with user needs, societal expectations, and regulatory
...
of risk. By providing a foundation for future research and best practices, this
work aims to advance the field of RE for AI.|
##### 2308.02047v1 **Acceptable risks in Europe's proposed AI Act: Reasonableness and other principles for deciding how much risk management is enough**
Henry Fraser et.al.
...
##### 2307.13704v3 **eXplainable Artificial Intelligence (XAI) in aging clock models**
Alena Kalyakulina et.al.
...
##### 2307.10404v2 **Interpreting and Correcting Medical Image Classification with PIP-Net**
Meike Nauta et.al.
...
##### 2307.07764v3 **Explaining and visualizing black-box models through counterfactual paths**
Bastian Pfeifer et.al.
...
##### 2307.02131v5 **Beyond Known Reality: Exploiting Counterfactual Explanations for Medical Research**
Toygar Tanyel et.al.
...
##### 2307.01210v1 **AI and Non AI Assessments for Dementia**
Mahboobeh Parsapoor et.al.
...
existing solutions.|
##### 2306.07306v1 **Active Globally Explainable Learning for Medical Images via Class Association Embedding and Cyclic Adversarial Generation**
Ruitao Xie et.al.
...
##### 2306.06029v1 **HiTZ@Antidote: Argumentation-driven Explainable Artificial Intelligence for Digital Medicine**
...
particular.|
##### 2306.04791v1 **XInsight: Revealing Model Insights for GNNs with Flow-based Explanations**
Eli Laird et.al.
...
##### 2306.03976v1 **Explainable AI using expressive Boolean formulas**
...
##### 2306.03902v1 **Utterance Classification with Logical Neural Network: Explainable AI for Mental Disorder Diagnosis**
...
##### 2306.01668v1 **XAI Renaissance: Redefining Interpretability in Medical Diagnostic Models**
Sujith K Mandala et.al.
...
##### 2305.16727v3 **A Novel real-time arrhythmia detection model using YOLOv8**
Guang Jun Nicholas Ang et.al.
...
##### 2305.14389v2 **Breast Cancer Segmentation using Attention-based Convolutional Network and Explainable AI**
Jai Vardhan et.al.
...
##### 2305.13127v2 **What Symptoms and How Long? An Interpretable AI Approach for Depression Detection in Social Media**
Junwei Kuang et.al.
...
##### 2305.10201v4 **Echoes of Biases: How Stigmatizing Language Affects AI Performance**
Yizhi Liu et.al.
...
##### 2305.03376v1 **Explaining the ghosts: Feminist intersectional XAI and cartography as methods to account for invisible labour**
Goda Klumbyte et.al.
...
invisible labour.|
##### 2304.13191v1 **Towards Explainable and Safe Conversational Agents for Mental Health: A Survey**
Surjodeep Sarkar et.al.
...
##### 2304.01543v1 **A Brief Review of Explainable Artificial Intelligence in Healthcare**
Zahra Sadeghi et.al.
...
##### 2303.12641v2 **Reveal to Revise: An Explainable AI Life Cycle for Iterative Bias Correction of Deep Models**
...
##### 2303.06365v1 **Explainable AI for Time Series via Virtual Inspection Layers**
...
##### 2303.04731v1 **Towards Trust of Explainable AI in Thyroid Nodule Diagnosis**
...
##### 2303.03140v1 **Cybersecurity of AI medical devices: risks, legislation, and challenges**
Elisabetta Biasin et.al.
...
##### 2302.03008v2 **LAVA: Granular Neuron-Level Explainable AI for Alzheimer's Disease Assessment from Fundus Images**
Nooshin Yousefzadeh et.al.
...
continuum.|
##### 2302.01241v2 **Diagrammatization: Rationalizing with diagrammatic AI explanations for abductive-deductive reasoning on hypotheses**
Brian Y. Lim et.al.
...
user-centric XAI.|
##### 2302.01104v1 **LesionAid: Vision Transformers-based Skin Lesion Generation and Classification**
Ghanta Sai Krishna et.al.
...
##### 2302.00785v1 **SkinCon: A skin disease dataset densely annotated by domain experts for fine-grained model debugging and analysis**
...
##### 2301.07835v1 **Decision-Focused Evaluation: Analyzing Performance of Deployed Restless Multi-Arm Bandits**
Paritosh Verma et.al.
...
system.|
##### 2302.03033v1 **Exemplars and Counterexemplars Explanations for Image Classifiers, Targeting Skin Lesion Labeling**
Carlo Metta et.al.
...
##### 2301.07060v1 **Monotonicity for AI ethics and society: An empirical study of the monotonic neural additive model in criminology, education, health care, and finance**
Dangxing Chen et.al.
...
##### 2301.06009v1 **Rationalizing Predictions by Adversarial Information Calibration**
Lei Sha et.al.
...
##### 2301.02080v3 **Semantic match: Debugging feature attribution methods in XAI for healthcare**
Giovanni Cinà et.al.
...
##### 2212.08821v1 **Context-dependent Explainability and Contestability for Trustworthy Medical Artificial Intelligence: Misclassification Identification of Morbidity Recognition Models in Preterm Infants**
Isil Guzey et.al.
...
final decisions.|
##### 2212.11136v2 **It is not "accuracy vs. explainability" -- we need both for trustworthy AI systems**
D. Petkovic et.al.
...
##### 2212.00951v1 **SimpleMind adds thinking to deep neural networks**
Youngwon Choi et.al.
...
##### 2211.14736v1 **Attribution-based XAI Methods in Computer Vision: A Review**
...
##### 2211.04110v1 **Privacy Meets Explainability: A Comprehensive Impact Benchmark**
...
##### 2211.02943v2 **Predicting Treatment Adherence of Tuberculosis Patients at Scale**
...
##### 2211.01036v2 **Explainable AI over the Internet of Things (IoT): Overview, State-of-the-Art and Future Directions**
Senthil Kumar Jagatheesaperumal et.al.
...
##### 2210.13535v2 **Human-centered XAI for Burn Depth Characterization**
...
framework.|
##### 2210.03506v1 **What Do End-Users Really Want? Investigation of Human-Centered XAI for Mobile Health Apps**
...
##### 2210.03332v1 **Explainable AI based Glaucoma Detection using Transfer Learning and LIME**
Touhidul Islam Chayan et.al.
...
##### 2209.15398v1 **Evaluation of importance estimators in deep learning classifiers for Computed Tomography**
Lennart Brocki et.al.
...
##### 2210.08979v1 **An Interactive Interpretability System for Breast Cancer Screening with Deep Learning**
Yuzhe Lu et.al.
...
##### 2209.06528v1 **Explainable AI for clinical and remote health applications: a survey on tabular and time series data**
...
methods.|
##### 2208.14742v1 **Enhancing Early Lung Cancer Detection on Chest Radiographs with AI-assistance: A Multi-Reader Study**
Gaetan Dissez et.al.
...
##### 2208.03099v1 **Planning and Scheduling in Digital Health with Answer Set Programming**
Marco Mochi et.al.
...
obtained.|
##### 2208.04698v1 **AI Approaches in Processing and Using Data in Personalized Medicine**
Mirjana Ivanovic et.al.
...
##### 2207.11290v2 **TRUST-LAPSE: An Explainable and Actionable Mistrust Scoring Framework for Model Monitoring**
Nandita Bhaskhar et.al.
...
##### 2207.05811v1 **Revealing Unfair Models by Mining Interpretable Evidence**
Mohit Bajaj et.al.
...
##### 2207.04969v1 **From Correlation to Causation: Formalizing Interpretable Machine Learning as a Statistical Process**
Lukas Klein et.al.
...
##### 2207.04295v1 **Explainable AI (XAI) in Biomedical Signal and Image Processing: Promises and Challenges**
Guang Yang et.al.
...
##### 2207.02726v1 **Towards the Use of Saliency Maps for Explaining Low-Quality Electrocardiograms to End Users**
Ana Lucic et.al.
...
##### 2206.15363v1 **Why we do need Explainable AI for Healthcare**
Giovanni Cinà et.al.
The recent spike in certified Artificial Intelligence (AI) tools for
healthcare has renewed the debate around adoption of this technology. One
...
##### 2206.13349v1 **Process Knowledge-Infused AI: Towards User-level Explainability, Interpretability, and Safety**
Amit Sheth et.al.
