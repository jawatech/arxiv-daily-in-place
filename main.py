        ...
        for result in arxiv_res: #'authors', 'categories', 'comment', 'doi', 'download_pdf', 'download_source',  'journal_ref', 'links', 'pdf_url', 'primary_category', 'summary', 'updated'
            ...
            _paper.update({
                paper_key: {
                    ...
                    "paper_summary_zh": translate(paper_summary).replace('法學碩士','LLM').replace('變壓器','Transformer'),
...
class _OverloadTasks:
    ...
    def generate_markdown_template(self, content: str):
        ...
        _tos = "> Welcome to contribute! Add your topics and keywords in " \
               "[`topic.yml`](https://github.com/jawatech/arxiv-daily-in-place/blob/main/database/topic.yml).\n"
        _tos += "> You can also view historical data through the " \
                "[storage](https://github.com/jawatech/arxiv-daily-in-place/blob/main/database/storage).\n"
